...
### Trazabilidad Big Picture → Requirements Specification

| Bounded Context | Eventos del Big Picture cubiertos | User Stories |
|---|---|---|
| Profiles and Verification / IAM | Registro de conductor, credenciales, vehículo, padre/tutor, estudiante y vínculo autorizado | US01-US07 |
| Subscriptions and Billing | Subscription Activated | US08 |
| Route and Trip Planning | Route Created hasta Trip Cancelled | US13-US22 |
| Real-Time Tracking and Execution | Trip Started, Stop Reached, Pickup/Drop-off, School Arrival, Return Trip, Trip Completed | US23-US27, US30-US33, US36, US38-US39, US46-US47 |
| Alerting and Incident Management | Delay, Incident, Notification e Issue Acknowledged | US28-US29, US37, US41, US43-US45, US48 |
| Privacy / data request | Student Data Deletion Requested | US40 |

Esta tabla usa únicamente los **41 eventos naranjas** del Big Picture. Las siete User Stories del Landing Page (US09-US12, US34-US35 y US42) son requisitos públicos del producto y no se presentan como eventos de dominio.
...
Este contexto supervisa la ejecución operativa del trayecto. Para mantener coherencia con el Big Picture EventStorming consolidado, incluye inicio del viaje, llegada y cierre de paradas, confirmación o pérdida de recojo, llegada al colegio, inicio del retorno, confirmación o rechazo de entrega, finalización del viaje y generación/consulta de su línea de tiempo. **GPS continuo, geofencing, ETA dinámico y verificación de cinturón no forman parte de los 41 eventos de dominio actuales y no se presentan como alcance del MVP.**
...
Este contexto administra la habilitación comercial del conductor. En el Big Picture EventStorming actual la trazabilidad obligatoria llega hasta `Subscription Activated` (US08). Pagos, comprobantes, renovaciones o cancelaciones podrán detallarse en iteraciones posteriores sin incorporarlos como nuevos eventos del Big Picture hasta que el equipo actualice también Requirements Specification.
...
| N/A | Requirements documentation | T10 | Requirements expansion | Consolidar las 41 HU de dominio, 7 HU de Landing Page, Technical Stories, Impact Mapping y Product Backlog. | 6 | Equipo Rumbo | Done |
| N/A | Product Design / DDD | T11 | DDD evidence | Alinear Bounded Contexts, Class Diagrams y Database Diagrams con el EventStorming corregido. | 6 | Kevin Geronimo / Equipo Rumbo | In-Process |
